...
<img alt="kamioka-data-SN1987A" src="./docs/image/kamioka-SN1987A-demo.png" width="600">
...
<img alt="Image" src="./docs/image/demo-hist1D.png" width="600">
...
<img alt="Image" src="./docs/image/demo-sep2graph.png" width="600">
...
<img alt="Image" src="./docs/image/demo-hist2D-hist.png" width="500">

- scatter mode (`mode` parameter set to be `'scatter'`)

<img alt="Image" src="./docs/image/demo-hist2D-scatter.png" width="500">
